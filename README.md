...
![主界面](https://github.com/user-attachments/assets/cd7323f4-aa40-4875-8c9b-29a672b3a02f)
...
- 🍨The initial deployment will perform full synchronization. If there are too many tables and the amount of data will occupy a certain amount of resources, it can be adjusted through the max threads. 
