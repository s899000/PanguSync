...
# PanguSync
## [PanguSync 8.5 官方正版下载](https://pan.baidu.com/s/1WesHaKGO7uQMhPNE-BTDmg?pwd=abcd#list/path=%2F)【[$\color{blue}{版本更新说明}$](https://gitee.com/AaronE_2890620459/pangu-sync/wikis/pages)】
...
3. 一机一码
4. 如不开发票，价格可聊
5. $\color{blue}{另外可接c#开发}$，包括但不限于winform、webform、wpf、webapi、sqlserver、oracle、mysql，按工作量收费
