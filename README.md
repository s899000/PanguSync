...
- 🍨The initial deployment will perform full synchronization. If there are too many tables and the amount of data will occupy a certain amount of resources, it can be adjusted through the 'Period' and 'Sleep Time'. 
